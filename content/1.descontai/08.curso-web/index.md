...
Você já estudou o **back-end** ([Curso da API](../curso)) e o **app mobile**
([Curso do App](../curso-app)). Falta a terceira frente do Descontai: os **portais web**. Neste
...
Este é o **passo 3** da [trilha completa](../), depois do [Curso da API](../curso) e do
[Curso do App](../curso-app). E é a **base dos três portais**: ao terminá-lo, os guias curtos do
[Admin](../guia-admin) e do [Site](../guia-web) cobrem só o que cada um tem de diferente — a
